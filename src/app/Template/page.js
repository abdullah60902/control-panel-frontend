...
const Page = () => {
    ...
    try {
      ...
      if (editingUserId) {
        ...
        response = await axios.put(
          `https://control-panel-frontend-sc75.vercel.app/templates/${editingUserId}`,
          data,
          config
        );
      } else {
        ...
        response = await axios.post(
          "https://control-panel-frontend-sc75.vercel.app/templates",
          data,
          config
        );
      }
      ...
      const res = await axios.get("https://control-panel-frontend-sc75.vercel.app/templates", config);
  ...
  useEffect(() => {
    const fetchHR = async () => {
      try {
        const token = localStorage.getItem("token");
        const res = await axios.get("https://control-panel-frontend-sc75.vercel.app/templates", {
  ...
  const handleDelete = (id) => {
    ...
    const token = localStorage.getItem("token");
    axios
      .delete(`https://control-panel-frontend-sc75.vercel.app/templates/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
