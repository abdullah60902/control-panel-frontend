...
const Page = () => {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      ...
      try {
        const res = await axios.get("https://control-panel-frontend-sc75.vercel.app/medication-administration/patients", {
    ...
    try {
      setLoading(true);
      const res = await axios.get(`https://control-panel-frontend-sc75.vercel.app/medication-administration/medications/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
 ...
 const handleDownloadCsv = (item) => {
  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      ...
      await axios.put(
        `https://control-panel-frontend-sc75.vercel.app/medications/${id}`,
        { status: newStatus },
        config
      );
      ...
      const res = await axios.get("https://control-panel-frontend-sc75.vercel.app/medications", config);
...
const handleSubmitCare = async (e) => {
  ...
  try {
    ...
    if (editingCareId) {
      response = await axios.put(
        `https://control-panel-frontend-sc75.vercel.app/medication-administration/${editingCareId}`,
        data,
        config
      );
    } else {
      response = await axios.post(
        "https://control-panel-frontend-sc75.vercel.app/medication-administration",
        data,
        config
      );
    }
  ...
  const handleDeleteCare = async (id) => {
    ...
    const token = localStorage.getItem("token");
    try {
      await axios.delete(`https://control-panel-frontend-sc75.vercel.app/medication-administration/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    axios
      .get("https://control-panel-frontend-sc75.vercel.app/medication-administration", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
