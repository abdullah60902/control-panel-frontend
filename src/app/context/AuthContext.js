...
const fetchLowStock = async () => {
  ...
  try {
    const res = await axios.get(
      "https://control-panel-frontend-sc75.vercel.app/medications/low-stock",
      {
...
// ✅ Auto refresh every 10s
  const fetchReviews = async () => {
    ...
    try {
      const res = await axios.get('https://control-panel-frontend-sc75.vercel.app/carePlanning/alerts', {
            headers: { Authorization: `Bearer ${token}` },
      });
