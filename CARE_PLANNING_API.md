...
const fetchCarePlans = async () => {
  ...
  const response = await axios.get("http://localhost:3000/carePlanning", {
...
const fetchClientCarePlans = async (clientId) => {
  ...
  const response = await fetch(
    `http://localhost:3000/carePlanning/client/${clientId}`,
    {
      headers: { Authorization: `Bearer ${token}` }
    }
  );
...
const deleteCarePlan = async (id) => {
  const token = localStorage.getItem("token");
  await axios.delete(`http://localhost:3000/carePlanning/${id}`, {
    headers: { Authorization: `Bearer ${token}` }
  });
};
```
...
const fetchArchivedPlans = async (clientId) => {
  ...
  try {
    ...
    const response = await axios.get(
      `http://localhost:3000/carePlanning/older-than-six-months/client/${clientId}`,
      {
        headers: { Authorization: `Bearer ${token}` }
      }
    );
    ...
    const response = await axios.get(
      "http://localhost:3000/carePlanning/older-than-six-months",
      {
        headers: { Authorization: `Bearer ${token}` }
      }
    );
